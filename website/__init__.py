        ...
        if not Event.query.first():
            sample_events = [
                Event(
                    ...
                    genre="Music",
                    photo="static/img/summervibesfestthumbnail.png",
                    status="Sold Out",
                ...
                Event(
                    ...
                    genre="Rock",
                    photo="static/img/rockrevolutionthumbnail.png",
                    status="Inactive",
                ...
                Event(
                    ...
                    genre="Electronic",
                    photo="static/img/flumethumbnail.png",
                    status="Open",
                ...
                Event(
                    ...
                    genre="Electronic",
                    photo="static/img/electricpulsethumbnail.png",
                    status="Cancelled",
                ...
                Event(
                    ...
                    genre="Jazz",
                    photo="static/img/bluesbrewsthumbnail.png",
                    status="Open",
                ...
                Event(
                    ...
                    genre="Country",
                    photo="static/img/folkinthewoodsthumbnail.png",
                    status="Sold Out",
